...
export class ChiptuneJsPlayer {
	...
	setStereoSeparation(val) { this.config.stereoSeparation = val; this.postMsg('setStereoSeparation', val) }
	setInterpolationFilter(val) { this.config.interpolationFilter = val; this.postMsg('setInterpolationFilter', val) }
